const ja = {
  ...
  home: {
    ...
    yourRepositoriesDescription: "現在の公開検索APIから取得できるリポジトリです。",
    yourRepositoriesEmptyTitle: "表示できるリポジトリはありません",
    yourRepositoriesEmptyBody: "このLoreHubに登録された公開リポジトリがここに表示されます。",
    activityTitle: "活動",
