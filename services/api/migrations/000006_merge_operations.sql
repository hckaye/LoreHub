...
CREATE TABLE merge_operations (
    ...
    push_authorized_revision varchar(128),
    push_authorized_actor_id uuid REFERENCES users (id) ON DELETE SET NULL,
    push_authorized_target_branch_id varchar(128),
    push_authorized_at timestamptz,
