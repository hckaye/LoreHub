...
func setRequiredEnvironment(t *testing.T) {
	...
	for _, name := range []string{
		"LOREHUB_NOTIFICATION_EMAIL_ENABLED", "LOREHUB_NOTIFICATION_EMAIL_POLL_PERIOD",
		"LOREHUB_NOTIFICATION_EMAIL_SEND_TIMEOUT", "LOREHUB_NOTIFICATION_EMAIL_LEASE_DURATION",
		"LOREHUB_NOTIFICATION_EMAIL_MAX_ATTEMPTS", "LOREHUB_SMTP_HOST", "LOREHUB_SMTP_PORT",
		"LOREHUB_SMTP_USERNAME", "LOREHUB_SMTP_PASSWORD", "LOREHUB_SMTP_FROM_ADDRESS",
		"LOREHUB_SMTP_FROM_NAME", "LOREHUB_SMTP_TLS_MODE",
	} {
		t.Setenv(name, "")
	}
